 ...
 */
public class AbcTransactionObject {
    private final static Logger LOG = LoggerFactory.getLogger(AbcTransactionObject.class);

    private AbcTransactionManager transactionManager;
    ...
    public AbcTransactionManager getTransactionManager() {
        return transactionManager;
    }

    public AbcTransactionObject(AbcTransactionManager transactionManager) {
